...
class dataset_norm(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img1 = Image.open(self.img_list1[index]).convert("L")  # original
        img2 = Image.open(self.img_list2[index]).convert("L")  # mask
        img3 = Image.open(self.img_list3[index]).convert("L")  # clahe
